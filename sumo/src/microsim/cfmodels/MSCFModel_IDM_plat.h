...
//
/****************************************************************************/
#ifndef MSCFMODEL_IDM_PLAT_H
#define MSCFMODEL_IDM_PLAT_H
...
public:
	...
	*/
     ...
     */
    MSCFModel_IDM_plat(const MSVehicleType* vtype, double accel, double decel, double emergencyDecel,
    ...
    int getModelID() const {
        return myAdaptationFactor == 1. ? SUMO_TAG_CF_IDM_PLAT : SUMO_TAG_CF_IDM;
    }
    /// @}
