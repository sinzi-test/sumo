...
//
/****************************************************************************/
#ifndef MSCFMODEL_IDM_CH_H
#define MSCFMODEL_IDM_CH_H
 ...
 * @see MSCFModel
 */
class MSCFModel_IDM_CH : public MSCFModel {
public:
    /** @brief Constructor
     ...
     */
    MSCFModel_IDM_CH(const MSVehicleType* vtype, double accel, double decel, double emergencyDecel, double apparentDecel,
    ...
    int getModelID() const {
        return myAdaptationFactor == 1. ? SUMO_TAG_CF_IDM_CH : SUMO_TAG_CF_IDMM;
    }
    /// @}
...
private:
    ...
    MSCFModel_IDM_CH& operator=(const MSCFModel_IDM_CH& s);
};

#endif /* MSCFMODEL_IDM_CH_H */
