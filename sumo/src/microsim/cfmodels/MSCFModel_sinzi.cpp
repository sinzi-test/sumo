...
// method definitions
// ===========================================================================
MSCFModel_sinzi::MSCFModel_sinzi(const MSVehicleType* vtype, double accel, double decel,
...
MSCFModel_sinzi::~MSCFModel_sinzi() {}


double
MSCFModel_sinzi::stopSpeed(const MSVehicle* const veh, const double speed, double gap) const {
...
double
MSCFModel_sinzi::followSpeed(const MSVehicle* const veh, double speed, double gap, double predSpeed, double predMaxDecel) const {
...
double
MSCFModel_sinzi::dawdle(double speed) const {
    if (!MSGlobals::gSemiImplicitEulerUpdate) {
...
MSCFModel*
MSCFModel_sinzi::duplicate(const MSVehicleType* vtype) const {
    return new MSCFModel_sinzi(vtype, myAccel, myDecel, myEmergencyDecel, myApparentDecel, myDawdle, myHeadwayTime);
}
