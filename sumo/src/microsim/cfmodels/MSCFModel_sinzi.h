...
//
/****************************************************************************/
#ifndef MSCFModel_sinzi_h
#define MSCFModel_sinzi_h
 ...
 * @see MSCFModel
 */
class MSCFModel_sinzi : public MSCFModel_KraussOrig1 {
public:
    /** @brief Constructor
     ...
     */
    MSCFModel_sinzi(const MSVehicleType* vtype, double accel, double decel,
