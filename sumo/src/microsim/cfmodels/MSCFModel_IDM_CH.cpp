...
// method definitions
// ===========================================================================
MSCFModel_IDM_CH::MSCFModel_IDM_CH(const MSVehicleType* vtype,
...
MSCFModel_IDM_CH::~MSCFModel_IDM_CH() {}


double
MSCFModel_IDM_CH::moveHelper(MSVehicle* const veh, double vPos) const {
...
double
MSCFModel_IDM_CH::followSpeed(const MSVehicle* const veh, double speed, double gap2pred, double predSpeed, double /*predMaxDecel*/) const {
    return _v(veh, gap2pred, speed, predSpeed, veh->getLane()->getVehicleMaxSpeed(veh));
}


double
MSCFModel_IDM_CH::stopSpeed(const MSVehicle* const veh, const double speed, double gap2pred) const {
    if (gap2pred < 0.01) {
        return 0;
    }
...
double
MSCFModel_IDM_CH::interactionGap(const MSVehicle* const veh, double vL) const {
...
double
MSCFModel_IDM_CH::_v(const MSVehicle* const veh, const double gap2pred, const double egoSpeed,
...
MSCFModel*
MSCFModel_IDM_CH::duplicate(const MSVehicleType* vtype) const {
    return new MSCFModel_IDM_CH(vtype, myAccel, myDecel, myEmergencyDecel, myApparentDecel, myHeadwayTime, myDelta, TS / myIterations);
}
